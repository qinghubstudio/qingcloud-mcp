...
HEADERS_FILE="search_headers.txt"
RESPONSE_FILE="search_response.json"
KEYWORD="重庆XSC试题"

echo -e "\033[36m=== Testing Search Function ===\033[0m"
