 ...
 * 添加音频工具
 */
public class AddAudioToolFactory {

    private static final Logger logger = LoggerFactory.getLogger(AddAudioToolFactory.class);
        ...
        return McpServerFeatures.SyncToolSpecification.builder()
                ...
                .callHandler((exchange, request) -> {
                    try {
                        ...
                        String audioUrl = getString(args, "audioUrl", null);

                        if (audioUrl == null || audioUrl.isEmpty()) {
                            return errorResult("Missing required parameter: audioUrl");
                        }
                        ...
                        String trackName = getString(args, "trackName", "audio_main");
                        ...
                        Map<String, Object> result = draftService.addAudio(
                                draftId, audioUrl, start, end, targetStart,
                        ...
                        logger.info("Added audio to draft: {}", result.get("draftId"));
                        ...
                        logger.error("Failed to add audio", e);
