...
public class LoginToolFactory {
        ...
        private static final Logger logger = LoggerFactory.getLogger(LoginToolFactory.class);
        ...
        public static McpServerFeatures.SyncToolSpecification create(PlaywrightBrowserManager browserManager) {
                Tool loginTool = new Tool(
                                "login",
                                "Get QR code for Xiaohongshu login and wait for user to scan. Returns QR code image URL or login status.",
                                null,
                                                ...
                                                if (qrcodeUrl == null) {
                                                        ...
                                                        return CallToolResult.builder()
                                                                        .content(List.of(new TextContent(
                                                                                        "{\"status\":\"already_logged_in\",\"message\":\"User is already logged in\"}")))
                                                                        .isError(false)
                                                                        .build();
                                                }
