...
public class PublishVideoToolFactory {
        ...
        private static final Logger logger = LoggerFactory.getLogger(PublishVideoToolFactory.class);
        ...
        public static McpServerFeatures.SyncToolSpecification create(PlaywrightBrowserManager browserManager) {
                ...
                Map<String, Object> videoProperty = Map.of(
                                "type", "string",
                                "description", "Local video file absolute path (e.g., /Users/user/video.mp4)");
                ...
                Tool publishVideoTool = new Tool(
                                "publish_with_video",
                                "Publish video content to Xiaohongshu. Only supports local video file paths.",
                                null,
                                inputSchema,
                                null, null, null);
