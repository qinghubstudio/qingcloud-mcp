...
public class PublishContentToolFactory {
        ...
        private static final Logger logger = LoggerFactory.getLogger(PublishContentToolFactory.class);
        ...
        public static McpServerFeatures.SyncToolSpecification create(
                ...
                Map<String, Object> titleProperty = Map.of(
                                "type", "string",
                                "description", "Content title (max 20 Chinese characters or 40 English words)");
                ...
                Map<String, Object> imagesProperty = Map.of(
                                "type", "array",
                                "description",
                                "Image path list (at least 1 image). Supports: 1. HTTP/HTTPS URLs (auto-download); 2. Local absolute paths (recommended)",
                ...
                Tool publishTool = new Tool(
                                "publish_content",
                                "Publish image-text content to Xiaohongshu. Supports both HTTP/HTTPS image URLs (auto-download) and local image paths.",
                                null,
                                inputSchema,
                                null, null, null);
